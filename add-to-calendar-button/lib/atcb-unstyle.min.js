 ...
 * Original file: /npm/add-to-calendar-button@2.11.0/dist/atcb-unstyle.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
!function(){window.atcb_action=function(e,n,t=!1){return async function(e,n,t=!1){if(!c())return;let a;try{a=await async function(){const n=Re(e);if(n.prokey&&""!==n.prokey&&(n.proKey=n.prokey),!n.proKey||""===n.proKey)return n;try{return await An(n.proKey,null,n)}catch(e){throw new Error(e.message)}}()}catch(e){return void console.error(e)}a.debug="true"===a.debug;try{await _(a)}catch(e){throw a.debug&&console.error(e),new Error("Add to Calendar Button generation failed: no data provided or missing required fields - see console logs for details")}a=await w(a);let o=document.body;a.trigger="click",n?(o=n,n.id&&""!==n.id?a.identifier=n.id:(a.identifier&&""!=a.identifier&&/^[\w-]+$/.test(a.identifier)?a.identifier="atcb-btn-"+a.identifier:a.identifier="atcb-btn-custom",n.id=a.identifier),"dropdown"!==a.listStyle&&"dropdown-static"!==a.listStyle&&"dropup-static"!==a.listStyle||(a.listStyle="modal")):(a.identifier="atcb-btn-custom",a.listStyle="modal");try{await P(a)}catch(e){return console.error(e),!1}const i=1===a.options.length,s=document.getElementById("atcb-customTrigger-"+a.identifier+"-host");s&&(ae(s.shadowRoot,!1),C[`${C.active}`]&&delete C[`${C.active}`],s.remove());if(Ge("initialization",a.identifier,a.identifier),!a.blockInteraction&&!a.hidden){const e=document.createElement("div");if(a.cspnonce&&""!==a.cspnonce&&e.setAttribute("cspnonce",a.cspnonce),e.id="atcb-customTrigger-"+a.identifier+"-host",o===document.body?document.body.append(e):o.after(e),n){const t=n.getBoundingClientRect();e.style.position="relative",e.style.left=-t.width+"px",e.style.top=t.height+"px"}e.setAttribute("atcb-button-id",a.identifier),e.attachShadow({mode:"open",delegateFocus:!0});const s=document.createElement("template");s.innerHTML=rn,e.shadowRoot.append(s.content.cloneNode(!0));const r=e.shadowRoot.querySelector(".atcb-initialized");hn(a),un(e.shadowRoot,a),e.shadowRoot.querySelector(".atcb-initialized").setAttribute("lang",a.language),bn(e.shadowRoot,r,a),gn(e.shadowRoot,a),a.rsvp&&Object.keys(a.rsvp).length>0?ie(e.shadowRoot,a,n,t):i?(Le(e.shadowRoot,a.options[0],a,"all",t),Ge("openSingletonLink",a.identifier,a.identifier)):ne(e.shadowRoot,"open",a,n,t)}fn(a.proKey,a.debug),a.debug&&console.log('Add to Calendar Button "'+a.identifier+'" triggered');return a.identifier}(e,n,t)}
/*!
 *  @preserve
 *
 * ++++++++++++++++++++++++++++++++++++++
